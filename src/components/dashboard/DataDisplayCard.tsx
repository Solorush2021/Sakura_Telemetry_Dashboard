...
export function DataDisplayCard({ title, value, unit, icon, className }: DataDisplayCardProps) {
  return (
    ...
    >
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 pt-4 px-10 md:px-12"> {/* Increased padding slightly */}
      ...
      <CardContent className="flex-grow flex flex-col justify-center p-6 pt-0 px-10 md:px-12 text-center"> {/* Increased padding slightly */}
