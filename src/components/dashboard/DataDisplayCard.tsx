...
export function DataDisplayCard({ title, value, unit, icon, className }: DataDisplayCardProps) {
  return (
    ...
    >
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 pt-4 px-8 md:px-10"> {/* Adjusted padding */}
      ...
      <CardContent className="flex-grow flex flex-col justify-center p-6 pt-0 px-8 md:px-10 text-center"> {/* Adjusted padding & text-center */}
